...
from ExynosM4_caches import *
from ExynosM4_FUnits import *
from ExynosM4_FUPool import *
...
parser.add_option('--itb_size', type="int", default=512, help="Instruction TLB size") # 512-entry

parser.add_option('--l1d_size', type="string", default="64kB", help="L1 data cache size")
parser.add_option('--l1d_assoc', type="int", default=8, help="L1 data cache associativity")
parser.add_option('--l1d_lat', type="int", default=4, help="L1 data cache latency")
parser.add_option('--dtb_size', type="int", default=544, help="Data TLB size") # 32-entry + 512-entry Mid-level DTLB

parser.add_option('--l2_size', type="string", default="512kB", help="Unified L2 cache size")
parser.add_option('--l2_assoc', type="int", default=8, help="Unified L2 cache associativity")
parser.add_option('--l2_lat', type="int", default=12, help="Unified L2 cache latency")
...
parser.add_option('--l3_lat', type="int", default=37, help="Shared L3 cache latency")
...
# Se necesita que este debe ser un multiplo de 64, pero en las specs esta en 48, en el diagrama
parser.add_option('--fb_entries', type="int", default=64, help="Number of fetch buffer entries")
parser.add_option('--fq_entries', type="int", default=64, help="Number of fetch queue entries")
parser.add_option('--iq_entries', type="int", default=64, help="Number of instruction queue entries")

parser.add_option('--rob_entries', type="int", default=228, help="Number of reorder buffer entries")
parser.add_option('--lq_entries', type="int", default=32, help="Number of load queue entries")
parser.add_option('--sq_entries', type="int", default=32, help="Number of store queue entries")
parser.add_option('--btb_entries', type="int", default=4096, help="Number of BTB entries")
parser.add_option('--ras_entries', type="int", default=64, help="Number of RAS entries")
...
parser.add_option('--num_fu_intDIVMUL', type="int", default=2, help="Number of execution units for integer Division and Multiplication instructions")
parser.add_option('--num_fu_FP_SIMD_ALU', type="int", default=3, help="Number of execution units for Floating-Point and SIMD instructions")
...
system.clk_domain.clock = '2.7GHz'
...
system.cpu.fuPool = ExynosM4_FUPool()
...
system.cpu.fuPool.FUList[5].count = options.num_fu_write # Write unit


# Setup number of substage for each pipeline stage
system.cpu.fetchToDecodeDelay = 3
system.cpu.decodeToRenameDelay = 3
...
binary = options.cmd
#binary="../openjpeg/build/bin/opj_compress"
